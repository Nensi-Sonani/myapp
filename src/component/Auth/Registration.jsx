    ...
    const handleSubmit = async (eve) => {
        ...
        if (Object.keys(validationError).length === 0) {
            try {
                ...
                const response = await axios.get(`https://naieldjewel.onrender.com/users?email=${formData.email}`);
                ...
                await axios.post('https://naieldjewel.onrender.com/users', formData);
