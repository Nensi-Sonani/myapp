            ...
            <div class="row g-0">
              <div className="col-12 col-md-6 d-flex align-items-stretch">
                <div style={{ width: "100%", overflow: "hidden" }}>
                  <img
                    src="https://i.pinimg.com/736x/ad/e9/6f/ade96f91c37afc53544fbebbd6eae978.jpg"
                    alt="Jewelry Img" style={{
                      width: "100%",
                      height: "100%",
                      objectFit: "contain",
                      display: "block"
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <p class="m-0 text-secondary text-center">Don't have an account?
                        <Link to='/register' class="link-primary text-decoration-none"> Register here </Link></p>
                    </div>
                  </div>
                  {/* <div class="row">
                                    <div class="col-12">
